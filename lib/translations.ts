...
export const translations = {
  en: {
    ...
    fenixblack: {
      title: 'FenixBlack.ai',
      subtitle: 'Complete AI marketing agency ecosystem with interactive avatars, brand design automation, and intelligent agents.',
      description: 'Main platform built with',
      description2: '+ custom React bridge.',
      description3: '6 satellite apps',
      description4: 'in Next.js.',
      description5: 'All developed in parallel while consulting and shipping other projects.',
    ...
    services: {
      ...
      startups: {
        title: 'For Startups',
        service1: 'MVP to production in weeks',
        service2: 'Full-stack AI implementation',
        service3: 'Technical architecture & system design',
        service4: 'Fractional CTO services',
      },
      enterprises: {
        title: 'For Enterprises',
        service1: 'Scale systems to millions of users',
        service2: 'AI/ML production deployment',
        service3: 'Legacy system modernization',
        service4: 'Technical due diligence',
      },
  ...
  es: {
    ...
    services: {
      ...
      startups: {
        ...
        service1: 'Tu idea en producción en 3-4 semanas',
        service2: 'Implementación completa con IA',
        service3: 'Arquitectura que escala desde el día uno',
        service4: 'CTO fraccionado para founders técnicos',
      },
      enterprises: {
        title: 'Si Lideras una Empresa',
        service1: 'Sistemas que soportan millones de usuarios',
        service2: 'IA en producción sin experimentos',
        service3: 'Modernización sin reescribir todo',
        service4: 'Auditoría técnica honesta',
      },
